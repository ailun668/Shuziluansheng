...
class sInputNumberElement extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [sInputNumberElement.#style];
    this.#shadowRoot.append(
      document.importNode(sInputNumberElement.#template.content, true)
    );
...
customElements.define("s-input-number", sInputNumberElement);
