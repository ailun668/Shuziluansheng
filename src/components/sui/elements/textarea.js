...
class sTextareaElement extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [sTextareaElement.#style];
    this.#shadowRoot.append(
      document.importNode(sTextareaElement.#template.content, true)
    );
...
customElements.define("s-textarea", sTextareaElement);
