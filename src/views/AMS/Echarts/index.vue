    ...
    <el-row class="layout">
      <el-col :span="8" class="type">
        <el-row class="container">
          ...
          <el-col class="h50" :span="12">
            <Render title="VFD RPM" :data="main_propulsion_vfd_rpm_indication" @handRange="handRange" type="voltage">
              <voltageChart
                class="chart-comp"
          ...
          <el-col class="h50" :span="12">
            <Render title="VFD Load" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="voltage">
              <voltageChart
                class="chart-comp"
          ...
          <el-col class="h50" :span="12">
            <Render title="Vfd Voltage" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
              <Gauge
                class="chart-comp"
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
      ...
      <el-col :span="16" class="type">
        <el-row class="container">
          <el-col class="h33" :span="6">
            <Render title="SPEED" :data="speedcomputed" @handRange="handRange" type="rudder">
          ...
          <el-col class="h33" :span="6">
            <Render title="Running Hours" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
          ...
          <el-col class="h33" :span="6">
            <Render title="Motor W Winding Temp." :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
              <pressure
                class="chart-comp"
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
          ...
          <el-col class="h33" :span="6">
            <Render title="VFD Current" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="voltage">
              <voltageChart
                class="chart-comp"
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
          ...
          <el-col class="h33" :span="6">
            <!-- 08012 -->
            <Render title="VFD Actual Torque" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
              <Rudder1
                class="chart-comp"
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
          ...
          <el-col class="h33" :span="6">
            <!-- 08014 -->
            <Render title="VFD Cooling Water" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
              <Gauge
                class="chart-comp"
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
          ...
          <el-col class="h33" :span="6">
            <Render title="Motor DE Bearing Temp." :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
              <Gauge
                class="chart-comp"
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
          ...
          <el-col class="h33" :span="6">
            ...
            <!-- <Render title="VFD Current" :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange"
              type="voltage">
          ...
          <el-col class="h33" :span="6">
            <!-- <Render title="VFD Current" :data="dataMap.no1_main_air_reservoir_pressure" @handRange="handRange"
              type="voltage"> -->
            <!-- </Render> -->
            <Render title="Start Air Press." :data="main_propulsion_motor_nde_bearing_temperature" @handRange="handRange" type="gauge">
              <numChart
                :value="main_propulsion_motor_nde_bearing_temperature.fieldValue"
                :data="main_propulsion_motor_nde_bearing_temperature"
                :unit="main_propulsion_motor_nde_bearing_temperature.unit"
