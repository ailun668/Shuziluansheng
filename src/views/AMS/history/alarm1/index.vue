      ...
      <Table :data="data" :column="column" :formData="formData" :showIndex="true" :selection="false" :border="true"
        ...
        <template #equipmentName>
          <el-select filterable v-model="deviceCode" placeholder="Select DeviceCode" style="width: 100%"
            ...
            <el-option v-for="(item, inx) in Equipmentsurvival" :key="item.deviceName + inx" :label="item.deviceName"
        ...
        <template #toolbar3>
          <SGbutton btnbg iconName="iconfontexport" :title="$t('export')" @handleClick="exportAsXLSX">
          </SGbutton>
        </template>
