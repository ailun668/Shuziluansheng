...
import detailDrawer from "./detailPerMinDrawer.vue";
...
export default {
    ...
    methods: {
        ...
        async getlist() {
            ...
            try {
                ...
                if (Object.keys(this.formData).length) {
                    ...
                    params.endTs = params.startTs + 24 * 3600000 - 1;
                    this.loading = true;
        ...
        detail(row) {
            this.$refs.detailDrawer.open("DetailsPerMinutes", row);
        },
    },
};
</script>
